  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={intl.formatMessage({ id: "pages.seo.description" })} />
      
        <meta name="keywords" content={intl.formatMessage({ id: "pages.seo.keywords" })} />
        ...
        <meta property="og:description" content={intl.formatMessage({ id: "pages.seo.description" })} />
