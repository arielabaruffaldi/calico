    ...
    <>
      ...
      <section className="mil-soft-bg">
        <div className="container mil-p-120-120">
            ...
            <div className="col-lg-10">
              <span
                ...
                dangerouslySetInnerHTML={{
                  __html: intl.formatMessage({ id: "page.testimonials.subtitle" }),
                }}
              />
            </div>
          </div>
          ...
          <h2
            className="lg:text-7xl mil-center mil-up mil-mb-60"
            dangerouslySetInnerHTML={{ __html: intl.formatMessage({id: "page.testimonials.title"}) }}
          />
